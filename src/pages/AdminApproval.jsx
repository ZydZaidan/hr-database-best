...
export default function AdminApproval() {
  ...
  const fetchSemuaAntrean = async () => {
    setIsLoading(true);
    try {
      // Poin 2: Cek Endpoint URL sesuai instruksi BE
      ...
      if (resData.ok) {
        ...
        // Poin 3: BE balikin Array langsung
      ...
      toast.error('Gagal terhubung ke server (Error 500).');
    } finally {
      setIsLoading(false);
    }
  };
  ...
  // --- Fungsi Handle Approve/Reject Tetap Sama ---
